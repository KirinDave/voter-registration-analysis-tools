<?php
/*
Gets the Total, Dem, Rep and Others who voted on 11-08-2016 per county, looking at the "last voted" date in a later data file. Writes summary to a file called oldpeoplewhovoted.csv in the directory containing the data subsets for this date
