...
Write summary details to list by county in subdir changedparty/

Write files of those who were added with a recent vote date ( > November 2009 ) to bad/recentvoter.txt or with a status of Inactive to changedparty/badinactive.txt

Syntax:
php getadded.php firstdate seconddate

Example:
php getchangedparties.php 2016-04-04 2016-11-07 

Output: 
changedparty/%countyname%_firstdate_seconddate.txt
changedparty/inactive.txt
changedparty/recentvoter.txt
changedparty/ids.txt
...
{
	$countyoutputfilename = 'changedparty/'.$county.'_'.$argv[1].'_'.$argv[2].'.txt';
